import { Activity, Archive, Folder, FolderPlus, MessageSquare, RefreshCw, Search, X, PanelLeftClose } from 'lucide-react';
...
export default function SidebarHeader({
  ...
  const LogoBlock = () => (
    <div className="flex min-w-0 items-center gap-2.5">
      <div className="flex h-[30px] w-[30px] flex-shrink-0 items-center justify-center rounded-md bg-primary">
      ...
      <h1 className="truncate font-sans text-[15.5px] font-bold tracking-[-0.01em] text-foreground">
        {t('app.title')}
      </h1>
    </div>
  );
          ...
          <div className="mt-2.5">
            <div className="relative">
              ...
              <Input
                ...
                className="h-8 rounded-md border border-border bg-card pl-8 pr-14 text-[12.5px] placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1"
              />
              {searchFilter ? (
                <button
                  onClick={onClearSearchFilter}
                  aria-label={t('tooltips.clearSearch')}
                  className="absolute right-2.5 top-1/2 -translate-y-1/2 rounded-md p-0.5 hover:bg-secondary"
                >
