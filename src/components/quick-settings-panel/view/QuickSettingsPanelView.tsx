...
export default function QuickSettingsPanelView() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed right-0 top-0 z-40 h-full w-72 transform border-l border-border bg-card shadow-xl transition-transform duration-150 ease-out ${isOpen ? 'translate-x-0' : 'translate-x-full'} ${isMobile ? 'h-screen' : ''}`}
      >
